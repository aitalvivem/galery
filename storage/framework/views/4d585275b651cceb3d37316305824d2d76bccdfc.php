<?php $__env->startSection('card_title'); ?>
    <?php echo e($photo->titre_photo); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('route_edit'); ?>
    <?php echo e(route('photos.edit', $photo->id)); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('card_img'); ?>
    <img class="card-img-top" style="max-height: 65vh;" src="<?php echo e(asset($photo->nom_file)); ?>" alt="<?php echo e($photo->titre_photo); ?>">
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('card_body'); ?>
    <div class="row">
        ...
        <?php if($photo->gallerie): ?>
            <p>Gallerie : <a href="<?php echo e(route('galleries.show', $photo->gallerie->id)); ?>"><?php echo e($photo->gallerie->nom_gallerie); ?></a></p>
        <?php endif; ?>
        </div>
        <div class="col-md-6">
            ...
            <div class="float-right">
                <a href="<?php echo e(route('photos.vote', $photo)); ?>" title="Vote" class="text-secondary">
    ...
    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ivry-galery/resources/views/photos/show.blade.php ENDPATH**/ ?>