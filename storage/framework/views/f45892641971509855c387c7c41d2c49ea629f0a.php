...
unset($__errorArgs, $__bag); ?>" name="titre_photo" value="<?php echo e(old('titre_photo', $photo->titre_photo)); ?>" required autocomplete="titre_photo" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="description" value="<?php echo e(old('description', $photo->description)); ?>" autocomplete="description" autofocus>
            ...
            <div class="col-md-6">
                <select name="gallerie_id">
                    ...
                    <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallerie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($gallerie->id); ?>" <?php if(isset($photo->gallerie)): ?> <?php if($gallerie->id == $photo->gallerie->id): ?>selected="true"<?php endif; ?> <?php endif; ?>><?php echo e($gallerie->nom_gallerie); ?></option>
                ...
                <div class="select is-multiple">
                    <select name="tags[]" multiple class="form-control" size="20">
                        <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tag->id); ?>" <?php echo e(in_array($tag->id, old('tags') ?: []) ? 'selected' : ''); ?> <?php if(in_array($tag->id, $tags_id)): ?>selected="true"<?php endif; ?>><?php echo e($tag->lib_tag); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('layouts.card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ivry-galery/resources/views/photos/edit.blade.php ENDPATH**/ ?>