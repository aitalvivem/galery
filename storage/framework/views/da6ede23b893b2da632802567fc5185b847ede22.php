<?php $__env->startSection('card_title'); ?>
    Tag : <?php echo e($tag->lib_tag); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('route_edit'); ?>
    <?php echo e(route('tags.edit', $tag->id)); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('card_body'); ?>
    <?php if($tag->photos->count() > 0): ?>
    <div class="container mt-3">
        <div class="row">
        <?php $__currentLoopData = $tag->photos->sortByDesc('votes'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="float-right">
                                    <a href="<?php echo e(route('tags.votePhoto', [$tag->id, $photo->id])); ?>" title="Vote" class="text-secondary">
    ...
    <?php else: ?>
    <p>Aucune photo n'est liée à ce tag pour l'instant.</p>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ivry-galery/resources/views/tags/show.blade.php ENDPATH**/ ?>